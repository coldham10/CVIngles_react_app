      ...
      let serviceBlock = (
        ...
        <Row><Col>
          <Card
              ...
              onClick={() => this.setState({'options': Object.assign({}, this.state.options, {service: 'p'})})}
          >
        ...
        <Col>
          <Card
              className="mx-auto my-4"
              style={{ width: '18rem' , height: '32rem', backgroundColor: (this.state.options.service === 't' ? "#5ca4a9" : "white")}}
              onClick={() => this.setState({'options': Object.assign({}, this.state.options, {service: 't'})})}
          >
        ...
        <Col>
          <Card
              ...
              onClick={() => this.setState({'options': Object.assign({}, this.state.options, {service: 'i'})})}
          >
        ...
        <Card
            ...
            style={{ width: '18rem' , height: '18rem', backgroundColor: (this.state.options.format === 0 ? "#5ca4a9" : "white")}}
        >
            ...
            <Card.ImgOverlay className="mb-0 pb-0 choice-style-overlay">
                ...
                <Button
                  variant="light"
                  className="mx-auto"
                  onClick={() => this.setState({'options': Object.assign({}, this.state.options, {format: 0})})}
                >Seleccione</Button>
                </Row>
                <hr />
                <Row>
        ...
        <Card
            className={'mx-auto my-4 p-1 style-choice'}
            style={{ width: '18rem' , height: '18rem', backgroundColor: (this.state.options.format === 1 ? "#5ca4a9" : "white")}}
        >
            ...
            <Card.ImgOverlay className="mb-0 pb-0 choice-style-overlay">
                ...
                <Button
                  variant="light"
                  className="mx-auto"
                  onClick={() => this.setState({'options': Object.assign({}, this.state.options, {format: 1})})}
                >Seleccione</Button>
                </Row>
                <hr />
                <Row>
        ...
        <Card
            className={'mx-auto my-4 p-1 style-choice'}
            style={{ width: '18rem' , height: '18rem', backgroundColor: (this.state.options.format === 2 ? "#5ca4a9" : "white")}}
        >
            ...
            <Card.ImgOverlay className="mb-0 pb-0 choice-style-overlay">
                ...
                <Button
                  variant="light"
                  className="mx-auto"
                  onClick={() => this.setState({'options': Object.assign({}, this.state.options, {format: 2})})}
                >Seleccione</Button>
                </Row>
                <hr />
                <Row>
            ...
            <Modal.Body className="p-0">
              ...
              >
                <Carousel.Item>
                  <Image
                    fluid
                    src={(function (that) { switch(that.state.showExample) {
                        case 0: return "fancy-0.jpg";
                        case 1: return "banking-0.jpg";
                        case 2: return "casual-0.jpg"
                      }
                    })(this)
                    } />
                </Carousel.Item>
                ...
                <Image
                  fluid
                  src={(function (that) { switch(that.state.showExample) {
                      case 0: return "fancy-1.jpg";
                      case 1: return "banking-1.jpg";
                      case 2: return "casual-1.jpg"
                    }
                  })(this)
                  } />
                </Carousel.Item>
            ...
            <Modal.Footer className="py-1">
              <Row className="mx-auto">
                <Col
                  ...
                  style={{border: ((this.state.examplePage === 1) ? "1px solid black": "0px solid black")}}
                >
                1
                </Col>
                <Col
                  className="py-1 px-2 mx-1"
                  style={{border: ((this.state.examplePage === 2) ? "1px solid black": "0px solid black")}}
                >
                2
                </Col>
              </Row>
        ...
        return (
            <Container className="choice px-0 px-md-3">
              ...
              <Button variant="secondary" className="mx-auto" onClick={() => this.submit()}>¡Cree su CV!</Button>
              </Container>
            </Container>
        );
    }
