...
class Home extends React.Component {
    ...
    render() {
        return (
            ...
            Si no esta comodo o tiene un sentido dificil traducir a inglés, también tenemos hispanohablantes bilingües que pueden trabajar mano a mano con nuestros editores para traducir y refinar exactamente que quiere decir.
            </p>
            <p className="p-2">
            ...
            <Card bg="light">
                <Card.Header>
                    <h4 className="p-1">Servicio de Lujo{/*Profesional, Perfeccion de contenido?*/}</h4>
                </Card.Header>
                <Card.Body>
                    ...
                    <p className="p-2">
                    <strong>Incluye también formato impesionante, edición de copia y traducción si es necesario.</strong>
                    </p>
                    <Button variant="secondary" onClick={() => this.submit('p')}>Empiece</Button>
                </Card.Body>
            </Card>
            </Container>
            ...
            <Card bg="light">
                ...
                <Card.Body>
                    <p className="p-2 pt-md-3">
                        A pesar de la mejora de la traducción automática, es todavía obvio cuando ha usado el traductor de Google - no tiene fluidez y es dificil etender.
                    </p>
                    <p className="p-2">
                        Con este servicio, su hoja de vida es traducido de español por nuestro equipo de hispanohablantes bilingües y luego editado por nuestro equipo angloparlante.
                        El resultado es <strong>un CV en inglés fluido y nativo con exactamente el mismo sentido que su hoja de vida en español</strong>.
                    </p>
                    <p className="p-2">
                    <strong>Incluye también formato impesionante y edición de copia.</strong>
                    </p>
                    <p className="p-2">
                    <Button variant="secondary" onClick={() => this.submit('t')}>Empiece</Button>
                    </p>
                </Card.Body>
            </Card>
            </Container>
            ...
            <Card bg="light">
                ...
                <Card.Body>
                    ...
                    <Button variant="secondary" onClick={() => this.submit('i')}>Empiece</Button>
                </Card.Body>
            </Card>
            </Container>
